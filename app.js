...
Application.prototype.start = function() {
  ...
  swal.fire('Welcome to TuneMe! This project is dedicated to the one and only boss band director Mr. Hicks!!!! Made by your one and only student, Arnav Ghosh :)').then(function() {
    self.tuner.init()
